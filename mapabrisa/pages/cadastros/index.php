  ...
  <body class="hold-transition skin-blue layout-top-nav">
        ...
        <nav class="navbar navbar-static-top">
          <div class="container">
            <div class="navbar-header">
              <a href="index.php" class="navbar-brand"><img src="/mapabrisa/dist/img/logoBrisanet.png" height="30px" width="140px">
    ...
    <script type="text/javascript">
      $('#cadastrar_mapa_brisanet').submit(function() {
        ...
        var dados = {};
        $('#cadastrar_mapa_brisanet').serializeArray().map(function(x){dados[x.name] = x.value;}); 
        console.log(dados);
        // Configurações para a requisição Ajax
        $.ajax({
          type: "POST",
          url: "/mapabrisa/server/cadastrarMapa.php",
          data: dados,
